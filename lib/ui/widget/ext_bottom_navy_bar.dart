...
/// Local fork from https://pub.dev/packages/bottom_navy_bar 5.6.0
...
class ExtBottomNavyBar extends StatelessWidget {
  ExtBottomNavyBar({
    Key? key,
  ...
  final List<ExtBottomNavyBarItem> items;
...
class _ItemWidget extends StatelessWidget {
  ...
  final ExtBottomNavyBarItem item;
  final Color backgroundColor;
  final double itemCornerRadius;
  final Duration animationDuration;
  final Curve curve;
...
/// The [ExtBottomNavyBar.items] definition.
class ExtBottomNavyBarItem {
  ExtBottomNavyBarItem({
    required this.icon,
    required this.title,
    this.activeColor = Colors.blue,
    this.activeBackgroundColor = Colors.yellow,
    this.textAlign,
    this.inactiveColor,
  });
